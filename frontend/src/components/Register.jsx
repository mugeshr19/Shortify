  ...
  return (
    <div className="relative min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm rounded-2xl bg-white/5 border border-white/10 p-8 overflow-hidden">
        ...
        <p className="text-white/40 text-sm mb-7">Start shortening links for free</p>
        ...
        <p className="text-white/40 text-xs text-center mt-6">
          ...
          <Link to="/login" className="text-white hover:text-white/70 transition underline underline-offset-2">
            Sign in
          </Link>
        </p>
      </div>
