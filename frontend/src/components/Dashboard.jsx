...
function Dashboard() {
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between rounded-2xl border border-white/10 bg-white/10 px-10 py-3 backdrop-blur-md">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="rounded-full border border-white/20 px-5 py-2 text-sm font-medium text-white transition hover:bg-white/10">
            Login
          </button>
    ...
    <div className="relative z-10 flex min-h-[70vh] flex-col items-center justify-center leading-none">
        ...
        <div className="mt-12">
        <button className="font-bold bg-white text-black px-8 py-3.5 text-lg border-2 border-black shadow-[4px_4px_0px_#888] hover:shadow-none hover:translate-x-[4px] hover:translate-y-[4px] transition-all flex items-center gap-2">
